###########################################################################
## Makefile generated for component 'App_code'. 
## 
## Makefile     : App_code.mk
## Generated on : Fri Dec 08 23:33:12 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/App_code.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/App_code.elf
...
DEFINES_STANDARD = -DMODEL=App_code -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = App_code.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/App_code_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/App_code_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/App_code_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
App_code.o : $(START_DIR)/App_code_ert_rtw/App_code.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/App_code_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
