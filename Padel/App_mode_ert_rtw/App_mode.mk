###########################################################################
## Makefile generated for component 'App_mode'. 
## 
## Makefile     : App_mode.mk
## Generated on : Fri Dec 08 13:59:54 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/App_mode.elf
...
SLIB_PATH                 = C:/Users/Dell/DOCUME~1/MATLAB/R2022b/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/App_mode.elf
...
DEFINES_STANDARD = -DMODEL=App_mode -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = App_mode.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/App_mode_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/App_mode_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/App_mode_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
App_mode.o : $(START_DIR)/App_mode_ert_rtw/App_mode.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/App_mode_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
