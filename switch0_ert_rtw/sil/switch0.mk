###########################################################################
## Makefile generated for component 'switch0'. 
## 
## Makefile     : switch0.mk
## Generated on : Sat Dec 30 01:29:46 2023
## Final product: ./switch0.exe
...
PRODUCT_NAME              = switch0
MAKEFILE                  = switch0.mk
MATLAB_ROOT               = D:/matlab
MATLAB_BIN                = D:/matlab/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = E:/MBD/Embedded_coder/switch_ON_OFF
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
MODELREF_LINK_RSPFILE     = switch0_ref.rsp
CMD_FILE                  = switch0.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/switch0_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/switch0_ert_rtw/sil -I$(START_DIR)/switch0_ert_rtw/coderassumptions -I$(MATLAB_ROOT)/toolbox/rtw/targets/pil/c -I$(MATLAB_ROOT)/extern/include/coder/connectivity/XILTgtAppSvc -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/extern/include/coder/connectivity/CoderAssumpTgtAppSvc
...
DEFINES_STANDARD = -DMODEL=switch0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
MODELREF_LIBS = ../switch0.obj

LIBS = $(START_DIR)/switch0_ert_rtw/coderassumptions/lib/switch0_ca.lib $(MATLAB_ROOT)/sys/lcc64/lcc64/lib64/wsock32.lib
...
xil_interface.obj : $(START_DIR)/switch0_ert_rtw/sil/xil_interface.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")


sil_main.obj : $(START_DIR)/switch0_ert_rtw/sil/sil_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
