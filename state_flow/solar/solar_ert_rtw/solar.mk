...
## 
## Makefile     : solar.mk
## Generated on : Wed Dec 20 21:15:30 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/solar.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/solar.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=1000000 -DMW_ARDUINO_MICROS -DARDUINO_NUM_SERIAL_PORTS=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_CONFIG_SERIAL0_=SERIAL_8N1 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=solar -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = solar.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/solar_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/solar_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/solar_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


solar.o : $(START_DIR)/solar_ert_rtw/solar.c
	$(CC) $(CFLAGS) -o "$@" "$<"
